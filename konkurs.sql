...
--
-- Host: 127.0.0.1
-- Czas generowania: 12 Kwi 2017, 02:09
...
CREATE TABLE `pytania` (
  ...
  `Pytanie` varchar(200) COLLATE utf8_polish_ci NOT NULL,
  `Odpowiedz_A` varchar(200) COLLATE utf8_polish_ci NOT NULL,
  `Odpowiedz_B` varchar(200) COLLATE utf8_polish_ci NOT NULL,
  `Odpowiedz_C` varchar(200) COLLATE utf8_polish_ci NOT NULL,
  `Opowiedz_Poprawna` varchar(200) COLLATE utf8_polish_ci NOT NULL
...
INSERT INTO `pytania` (`id_pytania`, `Pytanie`, `Odpowiedz_A`, `Odpowiedz_B`, `Odpowiedz_C`, `Opowiedz_Poprawna`) VALUES
(1, 'Ile ludzi mieszka w Warszawie?', '931 321', '1 748 916', '2 432 098', '1 748 916'),
(2, 'Ile dzielnic posiada Warszawa?', '5', '7', '11', '7');
...
--
ALTER TABLE `pytania`
  MODIFY `id_pytania` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
